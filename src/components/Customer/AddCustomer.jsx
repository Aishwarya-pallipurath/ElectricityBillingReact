    ...
    render() {
        ...
        return (
          <div style={{backgroundImage: `url(${img5})`, backgroundSize: "cover",padding:"100px"}}>
            ...
            <Card className="border border-dark  text-white" Style="width:50%;background-color:rgba(255,0,0,0);">
                <Card.Header >
   ...
   <Form.Row>
    ...
    <Form.Row>                          
        <Form.Group as={Col} controlId="formGridpassword">
            ...
            <Form.Control type="password" required="required" autoComplete="off" id="password" name="password" value={this.state.input.password} onChange={this.customerChange} placeholder="Enter your password." />
        ...
        <Card.Footer style={{ "textAlign": "right" }} >
            <div Style="text-align:left"><h6 >Already have an account? <a href="http://ec2-54-175-252-241.compute-1.amazonaws.com:3000/CustomerLogin" >Login</a></h6></div>
                        <ButtonGroup>
                            <Button size="lg" variant="success" type="submit" onClick={this.saveCustomer}>
                                <FontAwesomeIcon icon={faSave}></FontAwesomeIcon> Sign up
                            </Button>{''}
                            <Button size="lg" onClick={this.customerReset} variant="dark" type="reset">
